bgModeSelect = love.graphics.newImage("res/backgrounds/0.png")
bgMainMenu = love.graphics.newImage("res/backgrounds/title-no-icon.jpg")
bgNothing = love.graphics.newImage("res/backgrounds/nothing.png")
...
backgrounds = {
	...
	bgNothing,
	title = bgMainMenu,
	title_no_icon = bgMainMenu,
	title_night = bgMainMenu,
	snow = bgMainMenu,
	input_config = bgModeSelect,
	game_config = bgModeSelect,
}
